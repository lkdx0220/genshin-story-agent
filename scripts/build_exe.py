...
def build():
    ...
    args = [
        ...
        "--hidden-import=genshin_knowledge_base.artifacts",
        "--hidden-import=genshin_knowledge_base.materials",
        ...
        "--hidden-import=app.retrieval",
        "--hidden-import=app.formatters",
        "--hidden-import=app.rag_memory",
        "--hidden-import=app.progress",
        "--hidden-import=app.tools",
        "--hidden-import=app.tools.query",
        "--hidden-import=app.tools.list",
        "--hidden-import=app.tools.search",
        "--hidden-import=app.tools.content",
