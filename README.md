...
架构思想受 [Karpathy《LLM Wiki》](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) 模式启发：以人类策展的游戏 wiki（米游社观测枢 + B 站 Wiki 双源）为知识底座，构建"编译一次、保持更新"的结构化知识层，而非每次查询从原始文档重新检索推导。在此基础上，本项目额外处理了原文未涉及的开放访问场景问题（证据相关性闸门、防幻觉回归锚点）。
